...
0. ~~Retirer le `noindex`~~ **FAIT** : le site est indexable (`index,follow,max-image-preview:large`). Penser à soumettre le sitemap dans Google Search Console pour accélérer la prise en compte.
